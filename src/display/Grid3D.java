...
public class Grid3D implements Shape3D{
    ...
    public Grid3D(double width, double height){
        lines.add(new Line3D(new Vector3(-100,0,0), new Vector3(100,0,0)));
        lines.add(new Line3D(new Vector3(0,-100,0), new Vector3(0,100,0)));
        lines.add(new Line3D(new Vector3(0,0,-100), new Vector3(0,0,100)));
        for (int i=0; i< 10; i++){
